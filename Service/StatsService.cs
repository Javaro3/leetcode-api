    ...
    public string ConvertModelToSvg(StatsModel model){
        ...
        return 
            ...
            style='isolation: isolate' viewBox='0 0 410 186' width='410px' height='186px'>
                ...
                <text x='200' y='60' font-family='Helvetica' text-anchor='start' font-size='10px' fill='#807E7B'>Easy</text>
                <text x='250' y='60' font-family='Helvetica' text-anchor='start' font-size='10px' fill='#26262D' font-weight='bold'>
                    {model.SolvedEasyCount} <tspan fill='#807E7B' font-size='8px'>/{model.EasyCount}</tspan>
                </text>
                <text x='350' y='60' font-family='Helvetica' text-anchor='start' font-size='8px' fill='#807E7B' font-weight='bold'>Beats {model.EasyBeatsPercentage}%</text>
                ...
                <text x='200' y='100' font-family='Helvetica' text-anchor='start' font-size='10px' fill='#807E7B'>Medium</text>
                <text x='250' y='100' font-family='Helvetica' text-anchor='start' font-size='10px' fill='#26262D' font-weight='bold'>
                    {model.SolvedMediumCount} <tspan fill='#807E7B' font-size='8px'>/{model.MediumCount}</tspan>
                </text>
                <text x='350' y='100' font-family='Helvetica' text-anchor='start' font-size='8px' fill='#807E7B' font-weight='bold'>Beats {model.MediumBeatsPercentage}%</text>
                ...
                <text x='200' y='140' font-family='Helvetica' text-anchor='start' font-size='10px' fill='#807E7B'>Hard</text>
                <text x='250' y='140' font-family='Helvetica' text-anchor='start' font-size='10px' fill='#26262D' font-weight='bold'>
                    {model.SolvedHardCount} <tspan fill='#807E7B' font-size='8px' >/{model.HardCount}</tspan>
                </text>
                <text x='350' y='140' font-family='Helvetica' text-anchor='start' font-size='8px' fill='#807E7B' font-weight='bold'>Beats {model.HardBeatsPercentage}%</text>
