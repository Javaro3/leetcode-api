    ...
    public string ConvertModelToSvg(StatsModel model){
        ...
        return 
            ...
            style='isolation: isolate' viewBox='0 0 410 186' width='410px' height='186px'>
                ...
                <text x='16' y='25' font-family='Helvetica' font-size='10px' fill='#BFBDB8' font-weight='bold'>{model.Username} (Rank: {model.Rank})</text>
                
                <circle r='60' cx='90' cy='105' fill='none' stroke='#BFBDB8' stroke-width='3px'></circle>
                ...
                <text x='90' y='125' font-family='Helvetica' text-anchor='middle' font-size='15px' fill='#BFBDB8' font-weight='bold' >Solved</text>
                
                <text x='200' y='60' font-family='Helvetica' text-anchor='start' font-size='10px' fill='#BFBDB8'>Easy</text>
                <text x='250' y='60' font-family='Helvetica' text-anchor='start' font-size='10px' fill='#26262D' font-weight='bold'>
                    {model.SolvedEasyCount} <tspan fill='#BFBDB8' font-size='8px'>/{model.EasyCount}</tspan>
                </text>
                <text x='350' y='60' font-family='Helvetica' text-anchor='start' font-size='8px' fill='#BFBDB8' font-weight='bold'>Beats {model.EasyBeatsPercentage}%</text>
                ...
                <text x='200' y='100' font-family='Helvetica' text-anchor='start' font-size='10px' fill='#BFBDB8'>Medium</text>
                <text x='250' y='100' font-family='Helvetica' text-anchor='start' font-size='10px' fill='#26262D' font-weight='bold'>
                    {model.SolvedMediumCount} <tspan fill='#BFBDB8' font-size='8px'>/{model.MediumCount}</tspan>
                </text>
                <text x='350' y='100' font-family='Helvetica' text-anchor='start' font-size='8px' fill='#BFBDB8' font-weight='bold'>Beats {model.MediumBeatsPercentage}%</text>
                ...
                <text x='200' y='140' font-family='Helvetica' text-anchor='start' font-size='10px' fill='#BFBDB8'>Hard</text>
                <text x='250' y='140' font-family='Helvetica' text-anchor='start' font-size='10px' fill='#26262D' font-weight='bold'>
                    {model.SolvedHardCount} <tspan fill='#BFBDB8' font-size='8px' >/{model.HardCount}</tspan>
                </text>
                <text x='350' y='140' font-family='Helvetica' text-anchor='start' font-size='8px' fill='#BFBDB8' font-weight='bold'>Beats {model.HardBeatsPercentage}%</text>
